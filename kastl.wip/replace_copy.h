 ...
 *
 */
#ifndef _XKAAPI_REPLACE_COPY_H
#define _XKAAPI_REPLACE_COPY_H
#include "kaapi.h"
...
void replace_copy ( RandomAccessIterator1 begin, RandomAccessIterator1 end, RandomAccessIterator2 res, const T& old_value, const T& new_value);
...
public:
  ...
  typedef Replace_Copy_Struct<RandomAccessIterator1, RandomAccessIterator2, T> Self_t;
  ...
  Replace_Copy_Struct(
    ...
    const T& old_value,
    const T& new_value
  ) : _ibeg(ibeg), _iend(iend), _obeg(obeg), _old_value(old_value), _new_value(new_value) 
  {}
...
*/
template<class RandomAccessIterator1, class RandomAccessIterator2, class T>
void Replace_Copy_Struct<RandomAccessIterator1, RandomAccessIterator2, T>::doit(kaapi_task_t* task, kaapi_stack_t* stack)
{
...
void replace_copy(RandomAccessIterator1 begin, RandomAccessIterator1 end, RandomAccessIterator2 res, const T& old_value, const T& new_value)
{
  Replace_Copy_Struct<RandomAccessIterator1, RandomAccessIterator2, T> work(begin, end, res, old_value, new_value);
