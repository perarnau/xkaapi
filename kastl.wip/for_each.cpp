...
*/
void myfunction (val_t i) {
  if(i < val_t(10)) std::cout << " " << i << std::endl;
  if(i==val_t(50000000)) std::cout << " " << i << std::endl;
  if(i==val_t(80000000)) std::cout << " " << i << std::endl;
  if(i==val_t(90000000)) std::cout << " " << i << std::endl;
}
...
int main(int argc, char** argv)
{
  ...
  {
    //t0 = gettime();
    for_each(input, input+n, myfunction);
    //t1 = gettime();
    //ti[l] =  t1 - t0;
