...
%In addition to the user's created threads, the library maintains a set of kernel threads to execute the task of the program.
...
\end{minipage}
\vspace*{-44ex}
\caption{\small \kaapi stack before executing one instance of Fibonacci task. Task is pushed into the stack of tasks and the global data is pushed into the stack of data of the same \kaapi stack. Such construction is done during each recursive creation of Fibonacci task in the algorithm in figure~\ref{fig:fibo}.}
\vspace*{1ex}
\hrule
...
\subsubsection{Adaptive Fibonacci example}
...
\end{verbatim}
\caption{Adaptive version of the Fibonacci example}
\label{fig:fiboadapt}
\vspace*{1ex}
\hrule
\end{figure}
