...
\end{verbatim}
\verb+list_declaration+ is a rule in the grammar given in the appendix A.
...
#pragma kaapi task mode( array{ lda ; [n][m] }
#pragma kaapi task mode( array{ C; lda ; [n][m] }
#pragma kaapi task mode( array{ Fortran; lda ; [n][m] }
\end{verbatim}
...
All this rules are defined in the grammar of the appendix A.
...
%%%
%%%
\newpage \section{Compiler and runtime options}\label{sec:compilo}
...
The KaCC compiler add \texttt{--keep} to the option of the backend compiler.
This option allows to keep the intermediate file generated during the source to source translation.
...
They are mainly two environment variables that control the execution of \kaapi programs:
\begin{description}
...
\end{verbatim}
The identifier corresponds to system identifier of the core.
...
%%%
\newpage
\section{KaCC compiler and runtime options}
...
%%%
\newpage
\section{ SMPSs task model compatibility}
