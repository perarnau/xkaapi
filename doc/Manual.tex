...
\begin{verbatim}
 KAAPI_DISPLAY_PERF =1 ./fibo 30
\end{verbatim}
\item \verb+KAAPI_PERF_PAPI+: if defined and if PAPI library has been used to compile \kaapi, then it allows to select the list of hardware counters that the library will monitor.
\end{itemize}
