...
struct InitFormatClosure0 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread  ) )
  {
    ...
    FormatClosure0<TASK >::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread  ) )
  {
...
kaapi_task_bodyid_t FormatClosure0<TASK >::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread*  ) )
  {
      InitFormatClosure0<TASK >::registerbodycpu(
          FormatClosure0<TASK >::registerformat(), 
          &TASK::operator()
      );
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure0<TASK >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  >
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread*  ) )
  {
      InitFormatClosure0<TASK >::registerbodygpu(
          FormatClosure0<TASK >::registerformat(), 
          &TASK::operator()
      );
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure0<TASK >::registerformat() << std::endl;
  }
...
struct KaapiCPUBody1<true, TASK , TraitUAMParam_F1> {
  ...
  static void body(kaapi_task_t* task, kaapi_stack_t* stack)
  {
    TaskArg_t* args = (TaskArg_t*)task->sp;
...
struct FormatClosure1 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[1-1] = WrapperFormat<typeformat1_t>::get_format();
...
struct InitFormatClosure1 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure1<TASK , TraitUAMParam_F1>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure1<TASK ,TraitUAMParam_F1>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1 ) )
  {
      InitFormatClosure1<TASK ,TraitUAMParam<F1> >::registerbodycpu(
          FormatClosure1<TASK ,TraitUAMParam<F1> >::registerformat(), 
          &TASK::operator()
      );
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure1<TASK ,TraitUAMParam<F1> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1 ) )
  {
      InitFormatClosure1<TASK ,TraitUAMParam<F1> >::registerbodygpu(
          FormatClosure1<TASK ,TraitUAMParam<F1> >::registerformat(), 
          &TASK::operator()
      );
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure1<TASK ,TraitUAMParam<F1> >::registerformat() << std::endl;
  }
...
struct FormatClosure2 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[1-1] = WrapperFormat<typeformat1_t>::get_format();
    array_format[2-1] = WrapperFormat<typeformat2_t>::get_format();
...
struct InitFormatClosure2 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure2<TASK , TraitUAMParam_F1, TraitUAMParam_F2>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure2<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure2<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2 ) )
  {
      InitFormatClosure2<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2> >::registerbodygpu(
          FormatClosure2<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2> >::registerformat(), 
          &TASK::operator()
      );
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure2<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2> >::registerformat() << std::endl;
  }
...
struct FormatClosure3 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[1-1] = WrapperFormat<typeformat1_t>::get_format();
    array_format[2-1] = WrapperFormat<typeformat2_t>::get_format();
    array_format[3-1] = WrapperFormat<typeformat3_t>::get_format();
...
struct InitFormatClosure3 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure3<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure3<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure3<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3 ) )
  {
      InitFormatClosure3<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3> >::registerbodygpu(
          FormatClosure3<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3> >::registerformat(), 
          &TASK::operator()
      );
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure3<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3> >::registerformat() << std::endl;
  }
...
struct FormatClosure4 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[2-1] = WrapperFormat<typeformat2_t>::get_format();
    array_format[3-1] = WrapperFormat<typeformat3_t>::get_format();
    array_format[4-1] = WrapperFormat<typeformat4_t>::get_format();
...
struct InitFormatClosure4 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure4<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3, TraitUAMParam_F4>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure4<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3 ,TraitUAMParam_F4>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure4<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3, class F4>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4 ) )
  {
      InitFormatClosure4<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4> >::registerbodygpu(
          FormatClosure4<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4> >::registerformat(), 
          &TASK::operator()
      );
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure4<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4> >::registerformat() << std::endl;
  }
...
struct FormatClosure5 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[3-1] = WrapperFormat<typeformat3_t>::get_format();
    array_format[4-1] = WrapperFormat<typeformat4_t>::get_format();
    array_format[5-1] = WrapperFormat<typeformat5_t>::get_format();
...
struct InitFormatClosure5 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure5<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3, TraitUAMParam_F4, TraitUAMParam_F5>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure5<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3 ,TraitUAMParam_F4 ,TraitUAMParam_F5>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure5<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3, class F4, class F5>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5 ) )
  {
      ...
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure5<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5> >::registerformat() << std::endl;
  }
...
struct FormatClosure6 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[4-1] = WrapperFormat<typeformat4_t>::get_format();
    array_format[5-1] = WrapperFormat<typeformat5_t>::get_format();
    array_format[6-1] = WrapperFormat<typeformat6_t>::get_format();
...
struct InitFormatClosure6 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure6<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3, TraitUAMParam_F4, TraitUAMParam_F5, TraitUAMParam_F6>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure6<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3 ,TraitUAMParam_F4 ,TraitUAMParam_F5 ,TraitUAMParam_F6>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure6<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3, class F4, class F5, class F6>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6 ) )
  {
      ...
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure6<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6> >::registerformat() << std::endl;
  }
...
struct FormatClosure7 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[5-1] = WrapperFormat<typeformat5_t>::get_format();
    array_format[6-1] = WrapperFormat<typeformat6_t>::get_format();
    array_format[7-1] = WrapperFormat<typeformat7_t>::get_format();
...
struct InitFormatClosure7 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure7<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3, TraitUAMParam_F4, TraitUAMParam_F5, TraitUAMParam_F6, TraitUAMParam_F7>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure7<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3 ,TraitUAMParam_F4 ,TraitUAMParam_F5 ,TraitUAMParam_F6 ,TraitUAMParam_F7>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure7<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3, class F4, class F5, class F6, class F7>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7 ) )
  {
      ...
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure7<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7> >::registerformat() << std::endl;
  }
...
struct FormatClosure8 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[6-1] = WrapperFormat<typeformat6_t>::get_format();
    array_format[7-1] = WrapperFormat<typeformat7_t>::get_format();
    array_format[8-1] = WrapperFormat<typeformat8_t>::get_format();
...
struct InitFormatClosure8 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t, formal8_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure8<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3, TraitUAMParam_F4, TraitUAMParam_F5, TraitUAMParam_F6, TraitUAMParam_F7, TraitUAMParam_F8>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t, formal8_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure8<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3 ,TraitUAMParam_F4 ,TraitUAMParam_F5 ,TraitUAMParam_F6 ,TraitUAMParam_F7 ,TraitUAMParam_F8>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7, F8 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure8<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7>  ,TraitUAMParam<F8> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3, class F4, class F5, class F6, class F7, class F8>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7, F8 ) )
  {
      ...
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure8<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7>  ,TraitUAMParam<F8> >::registerformat() << std::endl;
  }
...
struct FormatClosure9 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[7-1] = WrapperFormat<typeformat7_t>::get_format();
    array_format[8-1] = WrapperFormat<typeformat8_t>::get_format();
    array_format[9-1] = WrapperFormat<typeformat9_t>::get_format();
...
struct InitFormatClosure9 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t, formal8_t, formal9_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure9<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3, TraitUAMParam_F4, TraitUAMParam_F5, TraitUAMParam_F6, TraitUAMParam_F7, TraitUAMParam_F8, TraitUAMParam_F9>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t, formal8_t, formal9_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure9<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3 ,TraitUAMParam_F4 ,TraitUAMParam_F5 ,TraitUAMParam_F6 ,TraitUAMParam_F7 ,TraitUAMParam_F8 ,TraitUAMParam_F9>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7, F8, F9 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure9<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7>  ,TraitUAMParam<F8>  ,TraitUAMParam<F9> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3, class F4, class F5, class F6, class F7, class F8, class F9>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7, F8, F9 ) )
  {
      ...
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure9<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7>  ,TraitUAMParam<F8>  ,TraitUAMParam<F9> >::registerformat() << std::endl;
  }
...
struct FormatClosure10 {
  ...
  static kaapi_format_t* registerformat()
  {
    ...
    array_format[8-1] = WrapperFormat<typeformat8_t>::get_format();
    array_format[9-1] = WrapperFormat<typeformat9_t>::get_format();
    array_format[10-1] = WrapperFormat<typeformat10_t>::get_format();
...
struct InitFormatClosure10 {
  ...
  static kaapi_format_t* registerbodycpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t, formal8_t, formal9_t, formal10_t ) )
  {
    kaapi_format_taskregister_body( fmt, registercpubody( fmt, &TaskBodyCPU<TASK>::operator() ), KAAPI_PROC_TYPE_CPU );
    /* here we assume CPU is the running processor */
    FormatClosure10<TASK , TraitUAMParam_F1, TraitUAMParam_F2, TraitUAMParam_F3, TraitUAMParam_F4, TraitUAMParam_F5, TraitUAMParam_F6, TraitUAMParam_F7, TraitUAMParam_F8, TraitUAMParam_F9, TraitUAMParam_F10>::default_body = 
      fmt->default_body = fmt->entrypoint[KAAPI_PROC_TYPE_CPU];
    return fmt;
  }
  static kaapi_format_t* registerbodygpu( kaapi_format_t* fmt, void (TASK::*method)( Thread* thread , formal1_t, formal2_t, formal3_t, formal4_t, formal5_t, formal6_t, formal7_t, formal8_t, formal9_t, formal10_t ) )
  {
    kaapi_format_taskregister_body( fmt, registergpubody( fmt, &TaskBodyGPU<TASK>::operator() ), KAAPI_PROC_TYPE_GPU );
    return fmt;
  }
...
kaapi_task_bodyid_t FormatClosure10<TASK ,TraitUAMParam_F1 ,TraitUAMParam_F2 ,TraitUAMParam_F3 ,TraitUAMParam_F4 ,TraitUAMParam_F5 ,TraitUAMParam_F6 ,TraitUAMParam_F7 ,TraitUAMParam_F8 ,TraitUAMParam_F9 ,TraitUAMParam_F10>::default_body =
  ...
  void DoRegisterBodyCPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7, F8, F9, F10 ) )
  {
      ...
      std::cout << "Register CPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure10<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7>  ,TraitUAMParam<F8>  ,TraitUAMParam<F9>  ,TraitUAMParam<F10> >::registerformat() << std::endl;
  }
  template<class TASK, class SIGNATURE  , class F1, class F2, class F3, class F4, class F5, class F6, class F7, class F8, class F9, class F10>
  void DoRegisterBodyGPU( void (SIGNATURE::*)( Thread* , F1, F2, F3, F4, F5, F6, F7, F8, F9, F10 ) )
  {
      ...
      std::cout << "Register GPU bodyid:" << __PRETTY_FUNCTION__ << ", fmt:" << FormatClosure10<TASK ,TraitUAMParam<F1>  ,TraitUAMParam<F2>  ,TraitUAMParam<F3>  ,TraitUAMParam<F4>  ,TraitUAMParam<F5>  ,TraitUAMParam<F6>  ,TraitUAMParam<F7>  ,TraitUAMParam<F8>  ,TraitUAMParam<F9>  ,TraitUAMParam<F10> >::registerformat() << std::endl;
  }
