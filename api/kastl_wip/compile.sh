...
/usr/bin/g++-4.5 -DKASTL_DEBUG=0 -std=gnu++0x -Wall -O3 -I$XKAAPI_INSTALL_DIR/include -I. -o main main.cc kastl_workqueue.cpp -L$XKAAPI_INSTALL_DIR/lib -lxkaapi -lpthread -ltbb
