...
#define DBGPRINTF(...) { fprintf( stderr, fmt, __VA_ARGS__ ); }
#else
...
// #define TASK_LOCK_TO_THREAD_MASK ( 1 << 16 )
...
#define Quark_Task_Flags_Initializer { (int)0, (int)-1, (char *)NULL, (char *)NULL, (void *)NULL, (int)1, (int)-1 }
