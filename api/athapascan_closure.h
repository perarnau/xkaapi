...
template<class TASK >
const kaapi_task_bodyid_t KaapiTaskArg0<TASK >::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1>
const kaapi_task_bodyid_t KaapiTaskArg1<TASK ,F1>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2>
const kaapi_task_bodyid_t KaapiTaskArg2<TASK ,F1 ,F2>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3>
const kaapi_task_bodyid_t KaapiTaskArg3<TASK ,F1 ,F2 ,F3>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3 ,class F4>
const kaapi_task_bodyid_t KaapiTaskArg4<TASK ,F1 ,F2 ,F3 ,F4>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3 ,class F4 ,class F5>
const kaapi_task_bodyid_t KaapiTaskArg5<TASK ,F1 ,F2 ,F3 ,F4 ,F5>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3 ,class F4 ,class F5 ,class F6>
const kaapi_task_bodyid_t KaapiTaskArg6<TASK ,F1 ,F2 ,F3 ,F4 ,F5 ,F6>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3 ,class F4 ,class F5 ,class F6 ,class F7>
const kaapi_task_bodyid_t KaapiTaskArg7<TASK ,F1 ,F2 ,F3 ,F4 ,F5 ,F6 ,F7>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3 ,class F4 ,class F5 ,class F6 ,class F7 ,class F8>
const kaapi_task_bodyid_t KaapiTaskArg8<TASK ,F1 ,F2 ,F3 ,F4 ,F5 ,F6 ,F7 ,F8>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3 ,class F4 ,class F5 ,class F6 ,class F7 ,class F8 ,class F9>
const kaapi_task_bodyid_t KaapiTaskArg9<TASK ,F1 ,F2 ,F3 ,F4 ,F5 ,F6 ,F7 ,F8 ,F9>::bodyid = registerformat()->bodyid;
...
template<class TASK ,class F1 ,class F2 ,class F3 ,class F4 ,class F5 ,class F6 ,class F7 ,class F8 ,class F9 ,class F10>
const kaapi_task_bodyid_t KaapiTaskArg10<TASK ,F1 ,F2 ,F3 ,F4 ,F5 ,F6 ,F7 ,F8 ,F9 ,F10>::bodyid = registerformat()->bodyid;
