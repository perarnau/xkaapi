...
#if 0    
    std::cout << "Sizeof(tbb::task)=" << sizeof(tbb::task) << std::endl;
    std::cout << "Sizeof(tbb::task_prefix)=" << sizeof(tbb::internal::task_prefix) << std::endl;
    std::cout << "Sizeof(tbb::no_copy)=" << sizeof(tbb::internal::no_copy) << std::endl;
    std::cout << "Sizeof(FibTask)=" << sizeof(FibTask) << std::endl;
#endif
    return sum;
}
