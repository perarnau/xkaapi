...
int kaapi_cuda_data_basic_allocate( 
	kaapi_format_t*		   fmt,
	void*              sp
)
{
	...
	for ( i=0; i < count_params; i++ ) {
		...
		kaapi_data_t* dest= xxx_kaapi_cuda_data_basic_allocate( cuda_map, kmd, src );
...
int kaapi_cuda_data_basic_send( 
	kaapi_format_t*		   fmt,
	void*              sp
)
{
...
int kaapi_cuda_data_basic_recv( 
	kaapi_format_t*		   fmt,
	void*              sp
)
{
