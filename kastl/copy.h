...
void copy ( kaapi_steal_context_t* stealcontext, RandomAccessIterator1 begin, RandomAccessIterator1 end, 
...
protected:  
  ...
  {
    CopyStruct<RandomAccessIterator1, RandomAccessIterator2>* w = (CopyStruct<RandomAccessIterator1, 
  ...
  */
                      ...
                      )
  {
    ...
    CopyStruct<RandomAccessIterator1, RandomAccessIterator2>* output_work =0;
    ...
    while (count >0)
    {
      if (request[i] !=0)
      {
        if (kaapi_steal_context_alloc_result( stealcontext, 
                                              request[i], 
                                              (void**)&output_work, 
                                              sizeof(CopyStruct<RandomAccessIterator1, RandomAccessIterator2>) 
                                            ) ==0)
        {
...
*/
template<class RandomAccessIterator1, class RandomAccessIterator2>
void CopyStruct<RandomAccessIterator1,RandomAccessIterator2>::doit()
{
...
*/
template<class RandomAccessIterator1, class RandomAccessIterator2>
void copy ( kaapi_steal_context_t* stealcontext, RandomAccessIterator1 begin, RandomAccessIterator1 end, RandomAccessIterator2 res)
{
  kaapi_steal_context_initpush( stealcontext );
  CopyStruct<RandomAccessIterator1, RandomAccessIterator2> work( stealcontext, begin, end, res);
  work.doit();
