 ...
 * Output :
 *
 * Creating n threads (with PROCESS SCOPE) and NB_MUTEX_ITERATIONS iterations on mutex for each thread
...
int main(int argc, char** argv)
{
  ...
  printf("Creating %i threads (with PROCESS SCOPE) and %i iterations on mutex for each thread\n", nthreads, NB_MUTEX_ITERATIONS );
