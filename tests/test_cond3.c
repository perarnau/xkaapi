 ...
 * Info :
 *
 * If you want to insure that kaapi_cond_timedwait does work when
 * signaled, just uncomment the call to kaapi_cond_signal in this code.
 *
...
//  { 
//    rc = kaapi_cond_signal(&cond_slave);
//    if (rc != 0) exit (rc);    
//  }
