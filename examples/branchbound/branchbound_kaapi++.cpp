...
/** main task */
struct TaskBB : public ka::Task<2>::Signature<ka::WP<bool>, node> {};

/** main task CPU implem */
struct TaskBodyCPU<TaskBB> {
  void operator() (ka::pointer_rw <bool> sync, node n) {
...
struct TaskPrint : public ka::Task<2>::Signature<ka::R<bool> > {};

/** main task CPU implem */
struct TaskBodyCPU<TaskPrint> {
  void operator()(ka::pointer_r<bool> r) 
  {
...
struct doit {
  void operator()(int argc, char ** argv) {
    node nodebase;
    bool sync;
    ka::Spawn<TaskBB>()( &sync,nodebase);
    ka::Spawn<TaskPrint>()(&sync);
  }
};
